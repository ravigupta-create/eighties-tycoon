...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function hs(e,t,n){let r=new Float32Array(ts),i=new K(0,1,0);return new ka({name:`SphericalGaussianBlur`,defines:{n:ts,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:vs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gs(){return new ka({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:vs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _s(){return new ka({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:vs(),fragmentShader:`
	...
	`}var ys=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Zr([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};qu.BlurDirectionX=new G(1,0),qu.BlurDirectionY=new G(0,1);var Ju={uniforms:{tDiffuse:{value:null},time:{value:0},scanlineIntensity:{value:.08},vignetteIntensity:{value:.3}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `};function Yu(e,t,n){let r=e.getSize(new G),i=new Wu(e),a=new Gu(t,n);i.addPass(a);let o=new qu(new G(r.x,r.y),.6,.4,.85);i.addPass(o);let s=new Vu(Ju);return i.addPass(s),{composer:i,retroPass:s,bloomPass:o}}function Xu(){let e=new X(new xa(400,32,32),new ka({uniforms:{topColor:{value:new Y(`#0a001a`)},midColor:{value:new Y(`#4a0060`)},horizonColor:{value:new Y(`#ff4400`)},offset:{value:20},exponent:{value:.4}},vertexShader:`
      varying vec3 vWorldPosition;
      void main() {
    ...
    `,side:1}));return e.name=`sky`,e}function Zu(){let e=2e3,t=new Float32Array(e*3),n=new Float32Array(e);for(let r=0;r<e;r++){let e=Math.random()*Math.PI*2,i=Math.acos(Math.random()*.7+.3);t[r*3]=350*Math.sin(i)*Math.cos(e),t[r*3+1]=350*Math.cos(i),t[r*3+2]=350*Math.sin(i)*Math.sin(e),n[r]=.5+Math.random()*1.5}let r=new ur;return r.setAttribute(`position`,new Yn(t,3)),r.setAttribute(`size`,new Yn(n,1)),new Yr(r,new Wr({color:`#ffffff`,size:.8,sizeAttenuation:!0,transparent:!0,opacity:.8}))}function Qu(e){let t=new Za(`#4a0080`,`#ff6600`,.4);e.add(t);let n=new ho(`#ff8844`,1.2);n.position.set(-50,30,-30),n.castShadow=!0,n.shadow.mapSize.width=2048,n.shadow.mapSize.height=2048,n.shadow.camera.near=1,n.shadow.camera.far=200,n.shadow.camera.left=-80,n.shadow.camera.right=80,n.shadow.camera.top=80,n.shadow.camera.bottom=-80,e.add(n);let r=new go(`#1a1a3a`,.3);e.add(r);let i=new X(new xa(8,16,16),new xr({color:`#ff6600`}));return i.position.set(-150,40,-100),e.add(i),{hemi:t,sun:n,ambient:r,sunMesh:i}}var $u=class{constructor(e){this.container=e,this.running=!1,this.clock=new zo,this.animationId=null,this.neonObjects=[],this.blinkObjects=[],this.time=0}init(){let e=this.container.clientWidth,t=this.container.clientHeight;this.renderer=new nu({antialias:!0,powerPreference:`high-performance`}),this.renderer.setSize(e,t),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.9,this.renderer.outputColorSpace=Re,this.container.appendChild(this.renderer.domElement),this.scene=new gn,this.scene.fog=new hn(`#0a001a`,.004),this.camera=new lo(75,e/t,.1,500),this.camera.position.set(0,1.7,5),this.sky=Xu(),this.scene.add(this.sky),this.stars=Zu(),this.scene.add(this.stars),this.lights=Qu(this.scene),this.city=_u(),this.scene.add(this.city),this.city.traverse(e=>{e.userData.neonFlicker&&this.neonObjects.push(e),e.userData.blink&&this.blinkObjects.push(e)});let n=Yu(this.renderer,this.scene,this.camera);this.composer=n.composer,this.retroPass=n.retroPass,this.controls=new Fu(this.camera,this.renderer.domElement),this.npcManager=new Ou(this.scene),this.npcManager.init(),this._onResize=()=>{let e=this.container.clientWidth,t=this.container.clientHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t),this.composer.setSize(e,t)},window.addEventListener(`resize`,this._onResize)}start(){this.running||(this.running=!0,this.clock.start(),this.controls.enable(),this._animate())}stop(){this.running=!1,this.controls.disable(),this.animationId&&=(cancelAnimationFrame(this.animationId),null)}_animate(){if(!this.running)return;this.animationId=requestAnimationFrame(()=>this._animate());let e=Math.min(this.clock.getDelta(),.05);this.time+=e,this.controls.update(e),this.npcManager.update(e,this.camera.position);for(let e of this.neonObjects){let t=Math.sin(this.time*e.userData.flickerSpeed*10)>0?1:Math.random()>.95?.3:1;e.material.opacity=t*.9}for(let e of this.blinkObjects)e.visible=Math.sin(this.time*2)>0;this.retroPass.uniforms.time.value=this.time,this.composer.render()}dispose(){this.stop(),window.removeEventListener(`resize`,this._onResize),this.npcManager.dispose(),this.scene.traverse(e=>{e.geometry&&e.geometry.dispose(),e.material&&(e.material.map&&e.material.map.dispose(),e.material.dispose())}),this.renderer.dispose(),this.renderer.domElement.parentNode&&this.renderer.domElement.parentNode.removeChild(this.renderer.domElement)}getPlayerPosition(){return this.camera.position.clone()}},$=t();function ed({state:e,dispatch:t,onExit:r}){let i=(0,n.useRef)(null),a=(0,n.useRef)(null),[o,s]=(0,n.useState)(!0),[c,l]=(0,n.useState)(!1);(0,n.useEffect)(()=>{if(!i.current)return;let e=new $u(i.current);e.init(),e.start(),a.current=e;let t=()=>{l(document.pointerLockElement===e.renderer.domElement)};document.addEventListener(`pointerlockchange`,t);let n=e=>{e.code===`Tab`&&(e.preventDefault(),r())};document.addEventListener(`keydown`,n);let o=setTimeout(()=>s(!1),6e3);return()=>{clearTimeout(o),document.removeEventListener(`pointerlockchange`,t),document.removeEventListener(`keydown`,n),e.dispose(),a.current=null}},[]);let u=()=>{a.current&&!c&&a.current.controls.requestPointerLock()};return(0,$.jsxs)(`div`,{className:`fixed inset-0 z-30 bg-black`,children:[(0,$.jsx)(`div`,{ref:i,className:`w-full h-full cursor-crosshair`,onClick:u}),!c&&(0,$.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center pointer-events-none z-40`,children:(0,$.jsxs)(`div`,{className:`bg-black/70 border border-amber rounded-lg px-6 py-4 text-center pointer-events-auto cursor-pointer`,onClick:u,children:[(0,$.jsx)(`p`,{className:`text-amber font-[family-name:var(--font-crt)] text-lg mb-1`,children:`CLICK TO EXPLORE`}),(0,$.jsx)(`p`,{className:`text-phosphor-dim font-[family-name:var(--font-crt)] text-xs`,children:`Click anywhere to enable mouse look`})]})}),(0,$.jsx)(`div`,{className:`absolute top-0 left-0 right-0 z-40 pointer-events-none`,children:(0,$.jsxs)(`div`,{className:`flex justify-between items-start p-4`,children:[(0,$.jsx)(`div`,{className:`bg-black/60 border border-crt-border rounded px-3 py-2 pointer-events-auto`,children:(0,$.jsxs)(`div`,{className:`flex items-center gap-4 text-xs font-[family-name:var(--font-crt)]`,children:[(0,$.jsxs)(`span`,{className:`text-phosphor`,children:[`$`,(e.cash||0).toLocaleString()]}),(0,$.jsxs)(`span`,{className:`text-amber`,children:[`HP: `,e.health,`%`]}),(0,$.jsxs)(`span`,{className:`text-[#00ffff]`,children:[`JOY: `,e.happiness,`%`]}),(0,$.jsxs)(`span`,{className:`text-amber-dim`,children:[e.reputation||0,` REP`]})]})}),(0,$.jsx)(`button`,{onClick:r,className:`bg-black/60 border border-phosphor rounded px-3 py-2 text-phosphor font-[family-name:var(--font-crt)] text-xs cursor-pointer hover:bg-phosphor hover:text-black transition-all pointer-events-auto`,children:`[ TERMINAL ] Tab`})]})}),o&&(0,$.jsx)(`div`,{className:`absolute bottom-6 left-1/2 -translate-x-1/2 z-40 pointer-events-none`,children:(0,$.jsx)(`div`,{className:`bg-black/70 border border-crt-border rounded-lg px-6 py-3 text-center`,children:(0,$.jsxs)(`div`,{className:`flex gap-6 text-xs font-[family-name:var(--font-crt)]`,children:[(0,$.jsxs)(`span`,{className:`text-phosphor`,children:[(0,$.jsx)(`span`,{className:`text-amber`,children:`W A S D`}),` Move`]}),(0,$.jsxs)(`span`,{className:`text-phosphor`,children:[(0,$.jsx)(`span`,{className:`text-amber`,children:`MOUSE`}),` Look`]}),(0,$.jsxs)(`span`,{className:`text-phosphor`,children:[(0,$.jsx)(`span`,{className:`text-amber`,children:`SHIFT`}),` Sprint`]}),(0,$.jsxs)(`span`,{className:`text-phosphor`,children:[(0,$.jsx)(`span`,{className:`text-amber`,children:`TAB`}),` Terminal`]}),(0,$.jsxs)(`span`,{className:`text-phosphor`,children:[(0,$.jsx)(`span`,{className:`text-amber`,children:`ESC`}),` Release Mouse`]})]})})}),c&&(0,$.jsx)(`div`,{className:`absolute inset-0 flex items-center justify-center pointer-events-none z-40`,children:(0,$.jsx)(`div`,{className:`w-1 h-1 bg-phosphor rounded-full shadow-[0_0_4px_#33ff33,0_0_8px_#33ff33]`})})]})}export{ed as default};